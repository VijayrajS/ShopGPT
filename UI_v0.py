...
with gr.Blocks() as demo:
    title = gr.HTML(value='''<img src="https://drive.google.com/uc?export=view&id=1amJbcxljmYMuXl8o4N-X7hu3BMnOrZTi" alt="Logo" width="50" height="50"><h1>ShopGPT</h1>''')
    ...
    def respond(message, chat_history):
        ...
        chat_history.append(("<p style='font-size: 20px;'>"+message+"</p>", '''<img src="https://drive.google.com/uc?export=view&id=1amJbcxljmYMuXl8o4N-X7hu3BMnOrZTi" alt="Logo" width="50" height="50">'''+bot_message))
        time.sleep(2)
        return "", chat_history
